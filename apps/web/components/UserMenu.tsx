...
const SEKTIONEN: Sektion[] = [
  ...
  },
  {
    ...
    ziele: [
      ...
      { id: "ki", label: "KI · Klartext + Voice", href: "/ki", farbe: "var(--accent)", matches: (p) => p === "/ki" },
      ...
      { id: "genossenschaft", label: "Genossenschaft", href: "/genossenschaft", farbe: "var(--sun)", matches: (p) => p.startsWith("/genossenschaft") },
