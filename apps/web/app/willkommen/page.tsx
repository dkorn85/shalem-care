    ...
    <div className="min-h-screen">
      <nav className="max-w-screen-app mx-auto px-4 sm:px-8 py-5 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <Link href="/" className="btn">{t("common.openApp")} →</Link>
        </div>
      </nav>

      <section className="max-w-screen-app mx-auto px-4 sm:px-8 pt-8 sm:pt-16 pb-12">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          <div className="lg:col-span-6">
            ...
            <div className="flex flex-wrap items-center gap-3 mt-7 anim-slideUp" style={{ animationDelay: "0.2s" }}>
              ...
              <Link href="/klient" className="btn text-[15px] px-5 py-2.5">
                {t("landing.cta.klient")}
              </Link>
              <Link href="/arzt" className="btn text-[15px] px-5 py-2.5">
                {t("landing.cta.doctor")}
              </Link>
              <Link href="/system" className="btn btn-ghost text-[15px] px-5 py-2.5">
                {t("landing.cta.system")}
              </Link>
            </div>
            <p className="text-[12px] text-soft mt-5 font-mono">
              {t("common.openSource")}
            </p>
          </div>

          <div className="lg:col-span-6 relative anim-slideUp" style={{ animationDelay: "0.3s" }}>
            <div className="absolute -inset-3 rounded-3xl bg-gradient-to-br from-mon-200 via-tue-200 to-sat-200 opacity-30 blur-2xl" />
            <div className="relative aspect-video rounded-2xl overflow-hidden surface">
              <video
                src="/loops/hero-sonne.mp4"
      ...
      <section className="max-w-screen-app mx-auto px-4 sm:px-8 py-16 sm:py-24">
      ...
      <section className="max-w-screen-app mx-auto px-4 sm:px-8 py-16 sm:py-20 border-t border-app-soft">
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-6 lg:order-2">
            <p className="text-[11px] uppercase tracking-wider text-soft mb-3 font-medium">Träger-Sicht</p>
            <h2 className="font-display text-[28px] sm:text-[34px] font-bold tracking-tight3 leading-tight">
              Stationsleitung mit Übersicht statt Excel-Tetris.
            </h2>
            <p className="text-[15px] text-mute mt-4 leading-relaxed">
              Die Admin-Oberfläche zeigt offene Tauschanträge, Team-Auslastung, ArbZG-Warnungen — ohne dass jemand drei Tabs gleichzeitig im Kopf halten muss. Genehmigung mit zwei Klicks, Audit-Log automatisch.
            </p>
            <Link href="/admin" className="btn mt-6 inline-flex">
              Träger-Admin öffnen →
            </Link>
          </div>
          <div className="lg:col-span-6 lg:order-1 relative">
            <div className="absolute -inset-3 rounded-3xl bg-gradient-to-br from-fri-200 via-thu-200 to-tue-200 opacity-25 blur-2xl" />
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden surface">
              <video
                src="/loops/hero-haende.mp4"
                autoPlay muted loop playsInline
                className="w-full h-full object-cover"
              />
            </div>
      ...
      {/* ─── Heilkunst-Bibliothek · Kneipp & Hausmittel ─── */}
      <section className="max-w-screen-app mx-auto px-4 sm:px-8 py-16 sm:py-24 border-t border-app-soft">
        ...
        <p className="text-[11px] text-soft mt-8 max-w-prose">
          Quellen: Hausmittelrunde 3.0.4 (Kneipp-Anwendungen, Hausmittel-Übersicht, Aromatherapie, Schmerzöle) ·
          Pflege-Handbuch 1.0 — Vom Kammerdiener zur Pflegekraft (Source Open). Die in den Anwendungen
          referenzierten Studien (Cochrane, AWMF, DNQP, NICE) sind im Therapie-Modul des Klienten-Detail
          verlinkt.
        </p>
      </section>
      ...
      <footer className="max-w-screen-app mx-auto px-4 sm:px-8 py-10 border-t border-app-soft">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5 text-[13px] text-mute">
            ...
            <Link href="/" className="hover:text-[rgb(var(--fg))]">App</Link>
          </div>
        </div>
      </footer>
    </div>
