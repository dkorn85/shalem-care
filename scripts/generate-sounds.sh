...
klick|0.1|0.6|A very short soft tap sound. Like a single fingertip touching a smooth glass surface. Warm organic no metallic edge. Just a brief gentle "tup" almost felt rather than heard. Low-mid frequencies no echo.
erfolg|0.3|0.5|A short warm bell tone like a tiny brass meditation chime struck gently. Two soft notes ascending a small interval (perfect fourth) quick decay. Calm and confirming not celebratory. Subtle reverb tail. Inspired by gentle iOS notification chimes but warmer and more acoustic.
fehler|0.25|0.5|A muffled descending two-tone buzz. Soft and apologetic not harsh. Like a gentle "uh-oh" played on a wooden percussion instrument. Two notes descending a minor third very brief. No sharp edges no electronic grit feels like wood not glass.
navigation|0.2|0.5|A soft whoosh sound like turning a page in a heavy book or sweeping a hand across paper. Subtle airflow with a gentle low-frequency tail. Organic and tactile no synthesizer feel. Very quiet and brief.
warnung|0.35|0.5|A soft warm warning chime three quick gentle taps on a low wooden block slightly resonant. Calm but attention-getting like a gentle hand on the shoulder. No alarm no urgency felt rather than heard. Inspired by Japanese temple wood blocks (mokugyō) but smaller and softer.
...
stempel|0.3|0.6|The organic sound of a rubber stamp pressing onto paper a soft "thump" with a brief paper-rustle aftertone. Wooden handle ink cushion real office feel. Warm low frequency no metallic ring. Brief and satisfying like sealing an envelope. Acoustic and physical.
